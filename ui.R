...
shinyUI(fixedPage(
  ...
  tabsetPanel(type = "pills",
              tabPanel("List of selected health disorders",
                       hr(),
                       fluidRow(
                         column(9,
                                prettyCheckboxGroup(
                         ...
                         column(3,
                                actionButton(inputId = "btn_list_disorders", label = "See list of disorders",
                                             icon = icon("info-circle"), width = "100%")
                         )
                       ),
                       tabsetPanel(type = "tabs",
                                   tabPanel("Summary of several disorders",
                                            hr(),
                                            fluidRow(
                                              column(5,
                                                     pickerInput(
                                            ...
                                            hidden(div(id = "main_panel_all999",
                                                       actionButton(inputId = "button_MRRLYLall999", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-down"), label = "Click to hide a panel of number of diagnosed, mortality rate ratios and life years lost"),
                                                       div(id = "MRRLYL_all999_show",
                                                           htmlOutput("Carson7"),
                                                       ...
                                                       actionButton(inputId = "button_MRRall999", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show mortality rate ratios only"),
                                                       hidden(div(id = "MRR_all999_show",
                                                       ...
                                                       actionButton(inputId = "button_LYLall999", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show life years lost only"),
                                                       hidden(div(id = "LYL_all999_show",
                                                       ...
                                                       actionButton(inputId = "button_airall999", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show mortality rate ratios after adjustment for air pollution"),
                                                       hidden(div(id = "air_all999_show",
                                   ...
                                   tabPanel("One specific disorder",
                                            hr(),
                                            fluidRow(
                                              column(6,
                                                     pickerInput(
                                            ...
                                            hidden(div(id = "panel999", 
                                                       ...
                                                       actionButton(inputId = "button_agedeath999", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show age-specific mortality rates and distribution of age of death"),
                                                       hidden(div(id = "agedeath999_show",
                                                                  htmlOutput("Carson3"),
                                                       ...
                                                       actionButton(inputId = "button_survival999", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show age-specific and cause-specific survival curves"),
                                                       hidden(div(id = "survival999_show",
                                                                  ...
                                                                  fluidRow(
                                                                    ...
                                                                    column(5,
                                                                           ...
                                                                           hidden(div(id = "cause_survival_not999",
                                                       ...
                                                       actionButton(inputId = "button_air999", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show mortality rate ratios after adjustment for air pollution"),
                                                       hidden(div(id = "air999_show",
              ...
              tabPanel("All ICD-10 diagnoses, groups and chapters",
                       hr(),
                       tabsetPanel(type = "tabs",
                                   tabPanel("Summary of several disorders",
                                            hr(),
                                            ...
                                            hidden(div(id = "main_panel_all",
                                                       actionButton(inputId = "button_MRRLYLall", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-down"), label = "Click to hide a panel of number of diagnosed, mortality rate ratios and life years lost"),
                                                       div(id = "MRRLYL_all_show",
                                                       ...
                                                       actionButton(inputId = "button_MRRall", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show mortality rate ratios only"),
                                                       hidden(div(id = "MRR_all_show",
                                                                  plotOutput("MRR_all"),
                                                                  h6("Mortality rate ratios for the selected sex and selected cause of death comparing those diagnosed with those not diagnosed with each specific
                ICD-10 chapter (left figure) and disorder (right figure). Estimates are available for disorders with at least 100 individuals diagnosed and at least 20 deaths.")
                                                       ...
                                                       actionButton(inputId = "button_LYLall", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show life years lost only"),
                                                       hidden(div(id = "LYL_all_show",
                                                                  plotOutput("LYL_all"),
                                                                  h6("Average Life Years Lost after diagnosis (difference in remaining life expectancy between those diagnosed and the age- and sex-matched
                general Danish population) for those diagnosed with each specific ICD-10 chapter (left figure) and disorder (right figure). Estimates available for disorders with at least 100 individuals diagnosed and at least 20 deaths, as long as there are enough diagnosed
                                                       ...
                                                       actionButton(inputId = "button_airall", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show mortality rate ratios after adjustment for air pollution"),
                                                       hidden(div(id = "air_all_show",
                ...
                chapter. One estimate is adjusted for air pollution, while the other is not (all estimates are adjusted 
                                   ...
                                   tabPanel("One specific disorder",
                                            ...
                                            hidden(div(id = "panel", 
                                                       hidden(div(id = "not_all_estimates", 
                                                                  HTML("<b>Note:</b> Some results are not available (panel below disabled) due to small number of individuals with this disorder.")
                                                       )),
                                                       
                                                       # Main table
                                                       
                                                       actionButton(inputId = "button_main", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-down"), label = "Click to hide table with main results"),
                                                       ...
                                                       actionButton(inputId = "button_agedx", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show age-specific incidence of the disorder and distribution of age of diagnosis"),
                                                       hidden(div(id = "agedx_show", 
                                                       ...
                                                       actionButton(inputId = "button_agedeath", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show age-specific mortality rates and distribution of age of death"),
                                                       hidden(div(id = "agedeath_show",
                                                       ...
                                                       actionButton(inputId = "button_lagged", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show mortality rate ratios depending on age and time since diagnosis"),
                                                       hidden(div(id = "lagged_show",
                                                                  plotOutput("MRRlagged"),
                                                                  htmlOutput("text_MRRlagged"),
                                                                  hr()
                                                       )),
                                                       actionButton(inputId = "button_LYLages", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show age-specific remaining life expectancy"),
                                                       hidden(div(id = "LYLages_show",
                                                                  plotOutput("LYLages"),
                                                                  htmlOutput("text_LYLages"),
                                                                  hr()
                                                                  )),
                                                       actionButton(inputId = "button_MRR", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show mortality due to specific causes of death"),
                                                       
                                                       hidden(div(id = "MRR_show",
                                                       ...
                                                       actionButton(inputId = "button_survival", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show age-specific and cause-specific survival curves"),
                                                       hidden(div(id = "survival_show",
                                                                  ...
                                                                  fluidRow(
                                                                    ...
                                                                    column(5,
                                                                           ...
                                                                           hidden(div(id = "cause_survival_not",
                                                                                      "Estimates available only for all causes due to small number of individuals with this disorder dying of external causes"
                                                                           ))
                                                                      )
                                                                  ),
                                                       ...
                                                       actionButton(inputId = "button_air", width = "100%", style = "color: white; background-color: grey", 
                                                                    icon = icon("chevron-right"), label = "Click to show mortality rate ratios after adjustment for air pollution"),
                                                       hidden(div(id = "air_show",
